            ...
            <main className="main-container">
                    ...
                    <figure className="details--img">
                        ...
                        <figcaption>
                            ...
                            <h4>
                                ...
                                adipisicing elit. Quidem odio in labore
                                obcaecati, magnam aliquam, illum iure, nihil
                                cupiditate repudiandae corrupti inventore sed
                                dolor quia eum ducimus animi quaerat?
                                Architecto.
                            </h4>
                        </figcaption>
                    </figure>
                ...
                <div className="container-grid--content">
                    <div className="recipe--ingredient">
                        <h4> Ingredientes </h4>
                        <ul>
                            {stateRecipe.recipe.ingredients.map(
                                (ingredient) => (
